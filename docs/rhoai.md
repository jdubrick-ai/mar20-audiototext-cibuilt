...
3) Access the `workbench` named `mar20-audiototext-cibuilt-notebook`.
...
5) In the terminal, run `cd mar20-audiototext-cibuilt` to navigate to your sample app's directory.
